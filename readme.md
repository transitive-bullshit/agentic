...
- [ChatGPT Prompts](https://github.com/pacholoamit/chatgpt-prompts) - A NodeJS library that features a collection of 140+ of the best prompts for ChatGPT from the community.
